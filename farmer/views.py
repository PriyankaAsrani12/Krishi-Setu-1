...
def cropdisease(request):
    ...
    if (request.method == 'POST'):
        ...
        # img_path="tomato_late_blight.JPG"
        # print(testimage)
    ...
    # x = preprocess_input(x)
        ...
        return render(request, "farmer/cropdisease.html",{'preds':preds , 'content':content})
...
def addproduct(request):
    if request.method=="POST":
        ...
        addprod=AddProduct(category=category,sub_category=subcategory,variety=variety,location=location,quantity=quantity,price=price,pub_date=date,image=myfile,aln=aln)
        addprod.save()
        prod=Product(category=category,sub_category=subcategory,variety=variety,location=location,quantity=quantity,price=price,pub_date=date,image=myfile)
        prod.save()
